...
export CHECKPOINT_PATH="${REPO_HOME}/checkpoints/rl/${EXP_NAME}_300steps/checkpoint-150"

cd ${REPO_HOME}/src/open-r1-multimodal

export DEBUG_MODE="true"
mkdir -p ${REPO_HOME}/runs/${EXP_NAME}/log
export LOG_PATH="${REPO_HOME}/runs/${EXP_NAME}/log/resume_training_log.$(date +%Y-%m-%d-%H-%M-%S).txt"
...
torchrun --nproc_per_node=8 \
    ...
    --use_vllm False \
    --output_dir ${REPO_HOME}/checkpoints/rl/${EXP_NAME}_300steps \
