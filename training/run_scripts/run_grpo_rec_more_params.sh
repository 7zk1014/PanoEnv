...
data_paths="./data/rec_jsonsl_train/refcoco_train.jsonl:./data/rec_jsonsl_train/refcocop_train.jsonl:./data/rec_jsonsl_train/refcocog_train.jsonl" 
image_folders="./data/coco:./data/coco:./data/coco"
model_path="./models/Qwen2.5-VL-3B-Instruct"
is_reward_customized_from_vlm_module=True
echo "data_paths: $data_paths"
echo "image_folders: $image_folders"

export EXP_NAME="Qwen2.5-VL-3B-Instruct-rec-more-params"
TASK_TYPE="rec"
